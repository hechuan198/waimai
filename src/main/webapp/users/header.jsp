            ...
            <div class="ng-bar-node reg-bar-node" id="reg-bar-node" style="display: block;">
                ...
                <c:if test="${sessionScope.userid != null }">
                    ...
                    <span><a style="color: #FF6766;" href="index/cart.action">[购物车]</a><a style="color: #FF6766;"
                            ...
                            style="color: #FF6766;" href="index/exit.action">[退出系统] </a> </span>
                </c:if>
            </div>
        </div>
    </div>
...
<div class="ng-header">
    <div class="ng-header-con block">
        <div class="ng-header-box">
            <a href="index/index.action" class="logo"> <img src="themes/xecmoban_haier2015/images/logo.gif"/>
            </a>
            <div class="ng-search">
                <div class="g-search">
    ...
    <div class="block">
        <div class="ng-nav-index">
            <ul class="ng-nav">
                ...
                <li><a href="index/recommend.action" class="cur">推荐菜品</a></li>
                <li><a href="index/all.action" class="cur">全部菜品</a></li>
            </ul>
        </div>
    </div>
</div>
